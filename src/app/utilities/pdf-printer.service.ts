...
export class PdfPrinterService {
   ...
   */
  public static generatePdfPrint(
    order: Order,
    key: string,
    ...
    restBackendService.getResource("customers").subscribe(
      (data) => {
        ...
        var customer: Customer = customers.find(
          (x) => x.idclienti === order.clienti_idclienti
        );
        ...
        restBackendService
          .getResourceQuery(
            "measuresQuery",
            "idclienti=" + String(order.clienti_idclienti)
          )
          .subscribe(
            (data) => {
              ...
              restBackendService
                .getResourceQuery("shirtsQuery", "idordini=" + order.idordini)
                .subscribe(
                  (data) => {
                    ...
                    restBackendService.getResource("subcontractors").subscribe(
                      (data) => {
                        ...
                        var subcontractor: Subcontractor = subcontractors.find(
                          (x) =>
                            x.idfasonatori === order.fasonatori_idfasonatori
                        );

                        PdfPrinterService.generatePdf(
                          order,
                          measure,
                          customer,
                          shirts,
  ...
  public static generatePdf(
    ...
    for (let index = 0; index < shirts.length; index++) {
      ...
      stringa =
        ...
        "collo: " +
        element.modellocollo +
        "\n" +
        "polso: " +
        element.modellopolso +
        "\n" +
        "avanti: " +
        element.avanti;
      ...
      stringa2 =
        ...
        "\n" +
        "tipo bottone: " +
        element.tipo_bottone +
        "\n" +
        "stecche estraibili: " +
        element.stecche_estraibili +
        "\n" +
        "tasca: " +
        element.tasca +
        "\n";
      ...
      if (element.presenza_iniziali == "SI") {
        stringa3 =
          ...
          "iniziali: " +
          element.presenza_iniziali +
          "\n" +
          "let. iniziali: " +
          element.iniziali +
          "\n" +
          "pos. iniziali: " +
          element.pos_iniziali +
          "\nstile:";
      ...
      if (element.note != "") stringa3 = stringa3 + "note: " + element.note;
    ...
    if (order.note == "") var noteCliente: string = "";
    else var noteCliente: string = order.note;

    if (order.note_x_fasonista == "") var noteFasonista: string = "";
    else var noteFasonista: string = order.note_x_fasonista;

    if (measure.note == "") var noteMisura: string = "";
    else var noteMisura: string = measure.note.toUpperCase();
          ...
          columns: [
            {
              text:
                ...
                "\n\n" +
                "Spalla x Lato: " +
                this.convertipositivi(measure.spalla) +
                "\n\n" +
                "Lun. Manica: " +
                this.convertipositivi(measure.lung_bicipite) +
                "\n\n" +
                "Bicipite Alto Tot x B.: " +
                this.convertipositivi(measure.bicipite) +
                "\n\n" +
                "Avamb Tot x B.: " +
            ...
            },
            {
              text:
                "Lun Camicia Dietro: " +
                this.convertipositivi(measure.bacino) +
                "\n\n" +
                "Lun Camicia: " +
                this.convertipositivi(measure.lung_camicia) +
                "\n\n" +
                "Centro Schiena: " +
                this.convertipositivi(measure.lung_avambraccio) +
                "\n\n" +
                "Vita: " +
                this.convertipositivi(measure.vita_dietro) +
                "\n\n" +
                "Bacino: " +
                this.convertipositivi(measure.bacino_dietro) +
                "\n\n" +
                "Polso: " +
                measure.polso +
                "\n\n" +
            ...
            },
            {
              text:
                ...
                "\n\n" +
                "1° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[0]) +
                "\n\n" +
                "2° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[1]) +
                "\n\n" +
                "3° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[2]) +
                "\n",
              style: "name",
            },
            {
              text:
                "AUMENTARE SOLO AVANTI" +
                "\n\n" +
                "4° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[3]) +
                "\n\n" +
                "5° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[4]) +
                "\n\n" +
                "6° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[5]) +
                "\n\n" +
                "7° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[6]) +
                "\n\n" +
                "8° Bottone: " +
                this.convertipositivi(measure.torace.split(";")[7]) +
                "\n",
              style: "name",
            },
          ],
  ...
  public static generateMeasureSheetPdf(
    measure: Measure,
    nomeCliente: string,
    ...
    if (measure.note == "") var noteMisura: string = "";
    else var noteMisura: string = measure.note;
